...
namespace GodGame
{
    public class Dauphin : EtreVivant,IReproduction
    {
        ...
        {
            return $"{m_nom} est un dauphin {m_sexe} ayant {m_nombreParents} parent(s) de regne Animal et est un eucaryote multicellulaires";
        }
