...
namespace GodGame
{
    public class Geochelone : EtreVivantReproduction
    {
        ...
        {
            return $"{m_nom} est un Geochelone de sexe {m_sexe} ayant {m_nombreParents} parent(s) de regne Animal et est un eucaryote multicellulaires";
        }
    }
}
